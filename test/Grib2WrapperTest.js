...
describe("Verifying if a point is in an area", function() {
    ...
    it("should work", function() {
        this.timeout(60000)
        grib2.isIn([{lat:48.487486,lon:-4.526367}, {lat:48.893615,lon:8.261719}, {lat:44.056012,lon:7.734375}, {lat:43.389082,lon:-1.669922}], {lat:50.007739,lon:1.494141}).should.be.false
        grib2.isIn([{lat:48.487486,lon:-4.526367}, {lat:48.893615,lon:8.261719}, {lat:44.056012,lon:7.734375}, {lat:43.389082,lon:-1.669922}], {lat:45.767523,lon:2.460938}).should.be.true
    })
