...
function readTemplate53(data) {
    ...
    template.groupSlittingMethod                    = Grib2Spec.readGroupSplittingMethod(data.readUInt8(21))
    template.missingValueManagement                 = Grib2Spec.readMissingValueManagement(data.readUInt8(22))
    template.primaryMissingValueSubstitute          = data.readUInt32BE(23)
    template.missingValueManagement                 = data.readUInt32BE(27)
