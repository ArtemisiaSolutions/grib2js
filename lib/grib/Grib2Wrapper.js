...
module.exports = function Grib2(pathToFile, pathToWGrib2) {
    ...
    this.generateFileFor = function(dataType, out, callback) {
        var queryParams = [self.file,"-V", "-match", "\"" + dataType + "\"", "-csv", out]

        child = exec(self.wgrib2 + " " + queryParams.join(" "),
